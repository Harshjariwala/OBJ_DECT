...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="C:/Users/Harsh Jariwala/Desktop/object_detection_demo/object_detection_demo-master/data/raw",
        type=str,
    )
    parser.add_argument(
        "--save-dir",
        help="Directory path to save resized images.",
        default="C:/Users/Harsh Jariwala/Desktop/object_detection_demo/object_detection_demo-master/data/images",
        type=str,
    )
    parser.add_argument(
